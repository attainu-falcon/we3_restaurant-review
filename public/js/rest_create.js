    ...
    var online_order =$('input[name=online_ordering]:checked').length;
     ...
     if(resturant_name.length<1) {
      ...
      return false;
        ...
        error_msg("owner name is required for registration");
        return false;
      }
      else if(email.length<1) {
        error_msg("Email is required for registration");
        return false;
      }
      else if (!(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email)))
      {
        ...
        error_msg("password is required for registration");
        return false;
      }
      else if(password.length<8) {
        error_msg("please enter a password with more than 8 characters for security reasons");
        return false;
      }
      else if(password!=password1) {
        error_msg("please check the password");
        return false;
      }
      else if(statef==null) {
